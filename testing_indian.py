...
def analysis():
    ...
    IMG_SIZE = 50
    LR = 1e-3
    MODEL_NAME = 'indian.model'.format(LR, '2conv-basic')
...
##            button.grid(column=0, row=6, padx=10, pady=10)
        ...
        elif str_label == 'chikki':
            status = "chikki"
            button2.destroy()
            r = tk.Label(text='STATUS: ' + status, background="darkcyan", fg="Brown", font=("", 15))
            r.grid(column=0, row=3, padx=10, pady=10) 
            predss="Predicted image of chikki is  {} % accuracy".format(model_out[3]*100)
            calo="The calorie in the predicted food item is {}%".format(sum1)            
            calo = tk.Label(text=calo, background="darkcyan", fg="white", font=("", 15))
            calo.grid(column=0, row=4, padx=10, pady=10)            
            calo = tk.Label(text=predss, background="darkcyan", fg="white", font=("", 15))
        ...
        elif str_label == 'mysorePaak':
            status = "mysorePaak"
            button2.destroy()
            r = tk.Label(text='STATUS: ' + status, background="darkcyan", fg="Brown", font=("", 15))
            r.grid(column=0, row=3, padx=10, pady=10) 
            predss="Predicted image of Mysore paak is  {} % accuracy".format(model_out[8]*100)
            calo="The calorie in the predicted food item is {}%".format(sum1)            
            calo = tk.Label(text=calo, background="darkcyan", fg="white", font=("", 15))
            calo.grid(column=0, row=4, padx=10, pady=10)            
            calo = tk.Label(text=predss, background="darkcyan", fg="white", font=("", 15))
...
def openphoto():
    ...
    fileName = askopenfilename(initialdir='C:\\Users\\Manoj M\\OneDrive\\Desktop\\food_classification (2)\\food_classification\\test', title='Select image for analysis ',
